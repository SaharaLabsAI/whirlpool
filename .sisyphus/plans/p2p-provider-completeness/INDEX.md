...
- [x] Task 5: whirlpool-node builder wiring [**M**] -> [tasks/05-whirlpool-node-builder-wiring.md](tasks/05-whirlpool-node-builder-wiring.md)
- [x] Task 6: Final Sub-Intent A verification [**M**] -> [tasks/06-final-subintent-a-verification.md](tasks/06-final-subintent-a-verification.md)
<!-- TASKS_END -->
