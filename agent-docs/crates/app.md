...
## Key Types
- `EvmBlock`: block type used by the app layer. Fields: `height: u64`, `parent_id: [u8; 32]`, `state_root: [u8; 32]`, `transactions_root: [u8; 32]`, `receipts_root: [u8; 32]`, `gas_used: u64`, `base_fee_per_gas: u64`, `timestamp: u64`, `transactions: Vec<Vec<u8>>`. Implements custom binary codec (write/read/size/digest).
