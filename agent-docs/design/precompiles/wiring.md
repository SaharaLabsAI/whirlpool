...
## Wiring path
- Registry assembly: `crates/app/evm/precompiles/src/lib.rs:94-124`.
- EVM factory seam: `crates/app/evm/precompiles/src/lib.rs:127-163`.
- App-level config seam: `crates/app/evm/app/src/config.rs:27`, `crates/app/evm/app/src/config.rs:103-108`, and `crates/app/evm/app/src/config.rs:195-199`.
...
## Validation strategy
- Unit coverage proves the config installs the registry: `crates/app/evm/app/src/config.rs:257-275`.
- Unit coverage proves replay accepts a block whose transaction reaches a precompile through a forwarding contract: `crates/app/evm/app/src/executor.rs:761-800`.
...
## Design consequence
If Whirlpool adds more custom precompiles, the intended extension point is the registry in `crates/app/evm/precompiles/src/lib.rs`, not ad hoc per-call-site wiring.
