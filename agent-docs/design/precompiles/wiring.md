...
- Avoid executor special-casing. Proposal and verification already go through `WhirlpoolEvmConfig`, so attaching the registry there keeps execution code simpler; see `agent-docs/crates/app-evm-execution.md`.
