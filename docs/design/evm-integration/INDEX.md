...
| File | Purpose | ~Lines |
|------|---------|--------|
| INTENT.md | Design scope and success criteria | ~74 |
...
| app-evm/README.md | App-evm crate contract pack | ~296 | working on app-evm crate |
...
| File | Purpose | ~Lines | Load when... |
|------|---------|--------|--------------|
| BLOCKERS.md | Open and resolved blockers | ~60 | checking blocker status |
...
| architecture/node-startup.md | Node startup current vs proposed wiring | ~91 | implementing/debugging node startup |
